-- Re-add consent_new_beetle (always true — checkbox is mandatory in UI, value tracked in DB)
alter table teams
  add column consent_new_beetle boolean not null default true;

-- Update RPC to hardcode true (no client param needed)
