...
import { Users, Newspaper, Image as ImageIcon, ShieldCheck, LogOut, Home, ExternalLink, Trophy, UserCircle, Menu, X, Handshake, Calendar, Target, MonitorPlay, Tv } from 'lucide-react'
...
const nav = [
  ...
  { href: '/admin/ledwall',         label: 'Ledwall',    icon: Tv },
